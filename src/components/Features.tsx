    ...
    <section id="solutions" className="py-20 bg-white" ref={featureRef}>
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Our platform leverages artificial intelligence to analyze financial
            data and provide valuable insights tailored to different
            stakeholders.
          </p>
        </div>
              ...
              <TabContent
                ...
                features={[
                  ...
                  },
                  {
                    ...
                    text: "Investment opportunity identification",
                  },
                  {
                    icon: <Shield size={20} />,
                    text: "Credit profile improvement",
                  },
                ]}
              />
            )}
            ...
            {activeTab === "lenders" && (
              <TabContent
                ...
                features={[
                  {
                    icon: <Layers size={20} />,
                    text: "Multi-dimensional credit scoring",
                  },
                  {
                    icon: <Shield size={20} />,
                    text: "Fraud detection algorithms",
                  },
                  {
                    icon: <Database size={20} />,
                    text: "Historical behavior analysis",
                  },
            ...
            {activeTab === "insurance" && (
              <TabContent
                ...
                features={[
                  ...
                  {
                    icon: <LineChart size={20} />,
                    text: "Premium calculation assistance",
                  },
                  {
                    icon: <Database size={20} />,
                    text: "Claims probability estimation",
                  },
                  {
                    icon: <Lock size={20} />,
            ...
            {activeTab === "fintechs" && (
              <TabContent
                ...
                features={[
                  {
                    icon: <PieChart size={20} />,
                    text: "Wealth management portfolio insights",
                  },
                  {
                    icon: <BarChart3 size={20} />,
                    text: "Alternative credit scoring for lending",
                  },
                  {
                    icon: <Zap size={20} />,
                    text: "Real-time financial health monitoring",
                  },
                  {
                    icon: <Database size={20} />,
...
const TabContent = ({ title, description, features }: TabContentProps) => (
  <div className="animate-fade-in">
    <h3 className="text-2xl md:text-3xl font-display font-bold text-brand-navy mb-4">
      {title}
    </h3>
