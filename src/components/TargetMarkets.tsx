...
import { 
  Building, Users, Shield, User, ArrowRight, 
  FileText, BarChart, Wallet, PieChart, Lock, Briefcase 
} from 'lucide-react';
  ...
  const markets = [
    {
      ...
      features: [
        { icon: <FileText size={16} />, text: 'Credit scoring enhancement' },
        { icon: <BarChart size={16} />, text: 'Risk assessment' },
        { icon: <Shield size={16} />, text: 'Fraud detection' }
      ]
    },
    {
      id: 'employers',
    ...
    },
    {
      ...
      features: [
        { icon: <PieChart size={16} />, text: 'Risk assessment' },
        { icon: <BarChart size={16} />, text: 'Premium optimization' },
        { icon: <Shield size={16} />, text: 'Fraud prevention' }
      ]
    },
    {
      id: 'individuals',
      ...
      features: [
        { icon: <Wallet size={16} />, text: 'Spending analysis' },
        { icon: <PieChart size={16} />, text: 'Savings recommendations' },
        { icon: <BarChart size={16} />, text: 'Investment guidance' }
      ]
    }
  ];

  return (
    <section id="target-markets" ref={sectionRef} className="py-20 bg-brand-cream/50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {markets.map((market, index) => (
            <div 
              key={market.id}
              className={`feature-card bg-white transition-all duration-500 ${
            ...
            >
              ...
              <a 
                href="#pricing" 
                className="inline-flex items-center text-sm font-medium text-brand-gold hover:text-brand-darkGold transition-colors"
              >
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">Banking Partners</p>
          </div>
